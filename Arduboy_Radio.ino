...
void setup() {
  ...
  rx.setup();
  rx.setVolume(5);  
  arduboy.print("Radio 98.10MHz");
  rx.setFrequency(9810); // The frequency you want to select in MHz multiplied by 100.

  
  arduboy.print("\nCurrent Channel: ");
  arduboy.print(rx.getRealChannel());
  delay(500);

  arduboy.print("\nReal Frequency.: ");
  arduboy.print(rx.getRealFrequency());
  
  arduboy.print("\nRSSI: ");
  arduboy.print(rx.getRssi());  
